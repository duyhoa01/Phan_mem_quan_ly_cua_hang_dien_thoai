...
namespace Cuahangdienthoai.View
{
    public partial class ThongtinNV : Form
    {
        ...
        public void SetGUI()
        {
            cbbChucVu.Items.Add(new CBBItem { Value = 1, Text = "Lau dọn" });
            cbbChucVu.Items.Add(new CBBItem { Value = 2, Text = "Quản lí" });
            ...
            if (chucNang == "edit")
            {
                ...
                foreach (CBBItem item in cbbChucVu.Items)
                {
                    if (item.Text == s.ChucVu) cbbChucVu.SelectedItem = item;
                }
            }
            else
            {
        ...
        private bool CheckData()
        {
            BLL_CHDT bll = new BLL_CHDT();
            bool check = true;
            if (tbTenNV.Text == "" || tbDC.Text == "" || tbCMND.Text == "" || tbSDT.Text == "") check = false;
            return check;
        }
